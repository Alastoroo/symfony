...
{
  $commerce = array(
    array('id' => 1, 'title' => 'Oculus Rift'),
    array('id' => 2, 'title' => 'HTC VIVE'),
    array('id' => 3, 'title' => 'PS VR'),
    array('id' => 4, 'title' => 'GTX 1060'),
    array('id' => 5, 'title' => 'GTX 1070'),
    array('id' => 6, 'title' => 'GTX 1080')
  );
  return $this->render('CBCommerceBundle:Commerce:menu.html.twig', array(
    'commerce' => $commerce
  ));
}
